...
const Hero = () => {
  return (
    ...
    //     <div className="max-w-md border text-justify">
    //       <h1 className="text-5xl font-bold">Mario Milošević</h1>
    //       <p className="py-6 text-2xl">FRONTEND DEVELOPER</p>
    ...
    //           height="24"
    //           viewBox="0 0 24 24"
    //           className="transition hover:scale-110 hover:rotate-[360deg] duration-700 bg-slate-50 rounded-full"
    //         >
