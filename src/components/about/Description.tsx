  ...
  return (
    <div className="flex flex-col justify-center gap-4 md:pl-8">
      ...
      <p className="text-justify md:text-base text-sm">
        ...
        applications, I am constantly advancing and refining my frontend
        expertise.
      </p>
      <p className="text-justify md:text-base text-sm">
        I have experience working with the Scrum methodology and am skilled in
        using Atlassian tools such as Jira and Sourcetree for agile project
        management.
      </p>
      <p className="text-justify md:text-base text-sm">
        Outside of work, I enjoy playing video games, watching TV shows, staying
        active through working out and cycling, and constantly striving for
        self-improvement. I truly believe that great things come only through
        discipline.
      </p>
    </div>
  );
